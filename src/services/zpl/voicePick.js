/**
 * CRC-16 & Voice Pick Code Generation
 * Used for PTI (Produce Traceability Initiative) voice pick codes
 */

// Hardcoded CRC-16 table from working Lua implementation
const crc16Table = [
 ...
 * @param {string} packDate - Pack date (formatted)
 * @returns {string} Voice pick code in format "XX-XX"
 */
